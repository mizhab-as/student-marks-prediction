...
![Dashboard Home](gallery/dashboard_home.jpg)

### 2. Dataset & Historical Records Explorer
Displays the data table and correlation scatter plot:
![Dashboard Dataset Exploration](gallery/dashboard_exploration.jpg)

### 3. Model Evaluation Dashboard Tab
The evaluation metrics cards, fitted regression plot, and actual-vs-predicted comparison:
![Dashboard Evaluation](gallery/dashboard_evaluation.jpg)

### 4. Matplotlib Exploratory Analysis (Static Plots)
